...
Detailed suggestions to user on how to write better petition by analysing input text.
`

const dilekceRequired = ["sentimentAnalysis", "toneAnalysis", "improvedPetitionFromUserText", "suggestionForUserText"];
